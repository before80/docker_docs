...
| ------------------------------------------------------------ | ------- | ---------------------------- |
| `-p, --password`                                             |         | Password                     |
| [`--password-stdin`](https://docs.docker.com/reference/cli/docker/login/#password-stdin) |         | Take the password from stdin |
| [`-u, --username`](https://docs.docker.com/reference/cli/docker/login/#username) |         | Username                     |
