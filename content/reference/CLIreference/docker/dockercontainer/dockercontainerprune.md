...
| ------------------------------------------------------------ | ------- | ------------------------------------------------ |
| [`--filter`](https://docs.docker.com/reference/cli/docker/container/prune/#filter) |         | Provide filter values (e.g. `until=<timestamp>`) |
...
[Description](https://docs.docker.com/reference/cli/docker/container/prune/#description)[Options](https://docs.docker.com/reference/cli/docker/container/prune/#options)[Examples](https://docs.docker.com/reference/cli/docker/container/prune/#examples)[Prune containers](https://docs.docker.com/reference/cli/docker/container/prune/#prune-containers)[Filtering (--filter)](https://docs.docker.com/reference/cli/docker/container/prune/#filter)
