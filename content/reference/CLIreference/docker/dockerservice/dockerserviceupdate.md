...
| [`--isolation`](https://docs.docker.com/reference/cli/docker/service/update/#isolation) |         | API 1.35+ Service container isolation mode                   |
...
| [`--mount-add`](https://docs.docker.com/reference/cli/docker/service/update/#mount-add) |         | Add or update a mount on a service                           |
| `--mount-rm`                                                 |         | Remove a mount by its target path                            |
| [`--network-add`](https://docs.docker.com/reference/cli/docker/service/update/#network-add) |         | API 1.29+ Add a network                                      |
...
| [`--publish-add`](https://docs.docker.com/reference/cli/docker/service/update/#publish-add) |         | Add or update a published port                               |
...
| [`--rollback`](https://docs.docker.com/reference/cli/docker/service/update/#rollback) |         | API 1.25+ Rollback to previous specification                 |
...
| [`--secret-add`](https://docs.docker.com/reference/cli/docker/service/update/#secret-add) |         | API 1.25+ Add or update a secret on a service                |
...
| [`--update-parallelism`](https://docs.docker.com/reference/cli/docker/service/update/#update-parallelism) |         | Maximum number of tasks updated simultaneously (0 to update all at once) |
