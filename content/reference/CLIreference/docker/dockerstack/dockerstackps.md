...
| ------------------------------------------------------------ | ------- | ------------------------------------------------------------ |
| [`-f, --filter`](https://docs.docker.com/reference/cli/docker/stack/ps/#filter) |         | Filter output based on conditions provided                   |
| [`--format`](https://docs.docker.com/reference/cli/docker/stack/ps/#format) |         | Format output using a custom template: 'table': Print output in table format with column headers (default) 'table TEMPLATE': Print output in table format using the given Go template 'json': Print in JSON format 'TEMPLATE': Print output using the given Go template. Refer to https://docs.docker.com/go/formatting/ for more information about formatting output with templates |
| [`--no-resolve`](https://docs.docker.com/reference/cli/docker/stack/ps/#no-resolve) |         | Do not map IDs to Names                                      |
| [`--no-trunc`](https://docs.docker.com/reference/cli/docker/stack/ps/#no-trunc) |         | Do not truncate output                                       |
| [`-q, --quiet`](https://docs.docker.com/reference/cli/docker/stack/ps/#quiet) |         | Only display task IDs                                        |
