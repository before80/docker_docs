...
| [`--ingress`](https://docs.docker.com/reference/cli/docker/network/create/#ingress) |          | API 1.29+ Create swarm routing-mesh network                |
| [`--internal`](https://docs.docker.com/reference/cli/docker/network/create/#internal) |          | Restrict external access to the network                    |
