...
| `DOCKER_CERT_PATH`            | Location of your authentication keys. This variable is used both by the `docker` CLI and the [`dockerd` daemon]({{< ref "/reference/CLIreference/dockerd" >}}) |
| `DOCKER_CONFIG`               | The location of your client configuration files.             |
| `DOCKER_CONTENT_TRUST_SERVER` | The URL of the Notary server to use. Defaults to the same URL as the registry. |
| `DOCKER_CONTENT_TRUST`        | When set Docker uses notary to sign and verify images. Equates to `--disable-content-trust=false` for build, create, pull, push, run. |
| `DOCKER_CONTEXT`              | Name of the `docker context` to use (overrides `DOCKER_HOST` env var and default context set with `docker context use`) |
| `DOCKER_CUSTOM_HEADERS`       | (Experimental) Configure [custom HTTP headers](https://docs.docker.com/reference/cli/docker/#custom-http-headers) to be sent by the client. Headers must be provided as a comma-separated list of `name=value` pairs. This is the equivalent to the `HttpHeaders` field in the configuration file. |
...
| `DOCKER_TLS_VERIFY`           | When set Docker uses TLS and verifies the remote. This variable is used both by the `docker` CLI and the [`dockerd` daemon]({{< ref "/reference/CLIreference/dockerd" >}}) |
| `BUILDKIT_PROGRESS`           | Set type of progress output (`auto`, `plain`, `tty`, `rawjson`) when [building](https://docs.docker.com/reference/cli/docker/image/build/) with [BuildKit backend]({{< ref "/manuals/DockerBuild/BuildKit" >}}). Use plain to show container output (default `auto`). |
...
| [`-H, --host`](https://docs.docker.com/reference/cli/docker/#host) |                          | Daemon socket to connect to                                  |
...
| Command                                                      | Description                                                  |
| :----------------------------------------------------------- | :----------------------------------------------------------- |
| [`docker build (legacy builder)`]({{< ref "/reference/CLIreference/docker/dockerbuildlegacybuilder" >}}) | Build an image from a Dockerfile                             |
| [`docker builder`]({{< ref "/reference/CLIreference/docker/dockerbuilder" >}}) | Manage builds                                                |
| [`docker buildx`]({{< ref "/reference/CLIreference/docker/dockerbuildx" >}}) | Docker Buildx                                                |
| [`docker checkpoint`]({{< ref "/reference/CLIreference/docker/dockercheckpoint" >}}) | Manage checkpoints                                           |
| [`docker compose`]({{< ref "/reference/CLIreference/docker/dockercompose" >}}) | Docker Compose                                               |
| [`docker config`]({{< ref "/reference/CLIreference/docker/dockerconfig" >}}) | Manage Swarm configs                                         |
| [`docker container`]({{< ref "/reference/CLIreference/docker/dockercontainer" >}}) | Manage containers                                            |
| [`docker context`]({{< ref "/reference/CLIreference/docker/dockercontext" >}}) | Manage contexts                                              |
| [`docker debug`]({{< ref "/reference/CLIreference/docker/dockerdebug" >}}) | Get a shell into any container or image. An alternative to debugging with `docker exec`. |
| [`docker image`]({{< ref "/reference/CLIreference/docker/dockerimage" >}}) | Manage images                                                |
| [`docker init`]({{< ref "/reference/CLIreference/docker/dockerinit" >}}) | Creates Docker-related starter files for your project        |
| [`docker inspect`]({{< ref "/reference/CLIreference/docker/dockerinspect" >}}) | Return low-level information on Docker objects               |
| [`docker login`]({{< ref "/reference/CLIreference/docker/dockerlogin" >}}) | Authenticate to a registry                                   |
| [`docker logout`]({{< ref "/reference/CLIreference/docker/dockerlogout" >}}) | Log out from a registry                                      |
| [`docker manifest`]({{< ref "/reference/CLIreference/docker/dockermanifest" >}}) | Manage Docker image manifests and manifest lists             |
| [`docker network`]({{< ref "/reference/CLIreference/docker/dockernetwork" >}}) | Manage networks                                              |
| [`docker node`]({{< ref "/reference/CLIreference/docker/dockernode" >}}) | Manage Swarm nodes                                           |
| [`docker plugin`]({{< ref "/reference/CLIreference/docker/dockerplugin" >}}) | Manage plugins                                               |
| [`docker scout`]({{< ref "/reference/CLIreference/docker/dockerscout" >}}) | Command line tool for Docker Scout                           |
| [`docker search`]({{< ref "/reference/CLIreference/docker/dockersearch" >}}) | Search Docker Hub for images                                 |
| [`docker secret`]({{< ref "/reference/CLIreference/docker/dockersecret" >}}) | Manage Swarm secrets                                         |
| [`docker service`]({{< ref "/reference/CLIreference/docker/dockerservice" >}}) | Manage Swarm services                                        |
| [`docker stack`]({{< ref "/reference/CLIreference/docker/dockerstack" >}}) | Manage Swarm stacks                                          |
| [`docker swarm`]({{< ref "/reference/CLIreference/docker/dockerswarm" >}}) | Manage Swarm                                                 |
| [`docker system`]({{< ref "/reference/CLIreference/docker/dockersystem" >}}) | Manage Docker                                                |
| [`docker trust`]({{< ref "/reference/CLIreference/docker/dockertrust" >}}) | Manage trust on Docker images                                |
| [`docker version`]({{< ref "/reference/CLIreference/docker/dockerversion" >}}) | Show the Docker version information                          |
| [`docker volume`]({{< ref "/reference/CLIreference/docker/dockervolume" >}}) | Manage volumes                                               |
