...
| Command                                                      | Description                                                  |
| :----------------------------------------------------------- | :----------------------------------------------------------- |
| [`docker manifest annotate`]({{< ref "/reference/CLIreference/docker/dockermanifest/dockermanifestannotate" >}}) | Add additional information to a local image manifest         |
| [`docker manifest create`]({{< ref "/reference/CLIreference/docker/dockermanifest/dockermanifestcreate" >}}) | Create a local manifest list for annotating and pushing to a registry |
| [`docker manifest inspect`]({{< ref "/reference/CLIreference/docker/dockermanifest/dockermanifestinspect" >}}) | Display an image manifest, or manifest list                  |
| [`docker manifest push`]({{< ref "/reference/CLIreference/docker/dockermanifest/dockermanifestpush" >}}) | Push a manifest list to a repository                         |
| [`docker manifest rm`]({{< ref "/reference/CLIreference/docker/dockermanifest/dockermanifestrm" >}}) | Delete one or more manifest lists from local storage         |
