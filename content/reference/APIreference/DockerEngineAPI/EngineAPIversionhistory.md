...
- `POST /session` (added in [V1.31](https://docs.docker.com/reference/api/engine/version-history/#v131-api-changes) is no longer experimental. This endpoint can be used to run interactive long-running protocols between the client and the daemon.
...
[Docker Engine API v1.24]({{< ref "/reference/APIreference/DockerEngineAPI/APIreferencebyversion/EngineAPIv1_24" >}}) documentation
