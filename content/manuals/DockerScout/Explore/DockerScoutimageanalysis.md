...
> 
>
> Image analysis on the Docker Scout platform has a maximum image file size limit of 10 GB, unless the image has an SBOM attestation. See [Maximum image size](https://docs.docker.com/scout/explore/analysis/#maximum-image-size).
...
> 
>
> Docker Desktop background indexing supports images up to 10 GB in size. See [Maximum image size](https://docs.docker.com/scout/explore/analysis/#maximum-image-size).
...
- `docker scout quickview`: summary of the specified image, see [Quickview](https://docs.docker.com/scout/explore/analysis/#quickview)
- `docker scout cves`: local analysis of the specified image, see [CVEs](https://docs.docker.com/scout/explore/analysis/#cves)
