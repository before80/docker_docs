...
This release changes how [health scores]({{< ref "/manuals/DockerScout/PolicyEvaluation/DockerScouthealthscores" >}}) are calculated in Docker Scout. The health score calculation now considers optional and custom policies that you have configured for your organization.
...
This release changes the out-of-the-box policies to align with the policy configurations used to evaluate Docker Scout [health scores]({{< ref "/manuals/DockerScout/PolicyEvaluation/DockerScouthealthscores" >}}).
...
For more information, see [Manage vulnerability exceptions]({{< ref "/manuals/DockerScout/Explore/Managevulnerabilityexceptions" >}}).

### 2024-05-06

New HTTP endpoint that lets you scrape data from Docker Scout with Prometheus, to create your own vulnerability and policy dashboards with Grafana. For more information, see [Docker Scout metrics exporter]({{< ref "/manuals/DockerScout/Explore/DockerScoutmetricsexporter" >}}).
...
For more information and setup instructions, see [Integrate Azure Container Registry]({{< ref "/manuals/DockerScout/Integrations/Containerregistries/AzureContainerRegistry" >}}).
...
For more information about the types of recommendations that Docker Scout can provide to help you improve policy compliance, see [Remediation]({{< ref "/manuals/DockerScout/PolicyEvaluation/RemediationwithDockerScout" >}}).

For more information about how to authorize the Docker Scout GitHub app on your source repositories, see [Integrate Docker Scout with GitHub]({{< ref "/manuals/DockerScout/Integrations/Sourcecodemanagement/GitHub" >}}).
...
To learn more about the integration and how to get started, see [Integrate Azure Container Registry]({{< ref "/manuals/DockerScout/Integrations/Containerregistries/AzureContainerRegistry" >}}).
...
For more information, see [Configurable policies]({{< ref "/manuals/DockerScout/PolicyEvaluation/Configurepolicies" >}}).
...
- [Policy Evaluation](https://docs.docker.com/scout/release-notes/platform/#policy-evaluation) (Early Access)
- [Amazon ECR integration](https://docs.docker.com/scout/release-notes/platform/#amazon-ecr-integration)
- [Sysdig integration](https://docs.docker.com/scout/release-notes/platform/#sysdig-integration)
- [JFrog Artifactory integration](https://docs.docker.com/scout/release-notes/platform/#jfrog-artifactory-integration)
...
![Policy overview in Dashboard](Platformreleasenotes_img/policy-ea.webp)
...
You can view and evaluate policy status for images using the Docker Scout Dashboard and the `docker scout policy` CLI command. For more information, refer to the [Policy Evaluation documentation]({{< ref "/manuals/DockerScout/PolicyEvaluation" >}}).
...
For more information and getting started, see [Sysdig integration documentation]({{< ref "/manuals/DockerScout/Integrations/IntegratingDockerScoutwithenvironments/Sysdig" >}}).

#### JFrog Artifactory integration

The new JFrog Artifactory integration enables automatic image analysis on Artifactory registries.

![Animation of how to integrate Artifactory](Platformreleasenotes_img/artifactory-agent.gif)

The integration involves deploying a Docker Scout Artifactory agent that polls for new images, performs analysis, and uploads results to Docker Scout, all while preserving the integrity of image data. Learn more in the [Artifactory integration documentation]({{< ref "/manuals/DockerScout/Integrations/Containerregistries/Artifactory" >}})
