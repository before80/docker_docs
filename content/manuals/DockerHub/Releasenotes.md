...
- You can tag Docker Hub repositories with [categories]({{< ref "/manuals/DockerHub/Managerepositories/CategoriesinDockerHub" >}}).
...
- Organizations can assign the [editor role]({{< ref "/manuals/Security/Foradmins/Rolesandpermissions" >}}) to members to grant additional permissions without full administrative access.

## 2023-05-09

### New

- Docker Business subscribers can now [create a company]({{< ref "/manuals/Administration/Companyadministration/Createacompany" >}}) in Docker Hub to manage organizations and settings.

## 2023-03-07

### New

- You can now automatically sync user updates with your Docker organizations and teams with [Group Mapping]({{< ref "/manuals/Security/Foradmins/Provisioning/Groupmapping" >}}) for SSO and SCIM provisioning.
...
- In Docker Hub, you can now download a [registry.json]({{< ref "/manuals/Security/Foradmins/Enforcesign-in" >}}) file or copy the commands to create a registry.json file to enforce sign-in for your organization.
...
- With [SCIM]({{< ref "/manuals/Security/Foradmins/Provisioning/SCIM" >}}), you can manage users within your Okta identity provider (IdP). In addition, you can enable SCIM on organizations that are part of the Docker Business subscription.

## 2022-05-24

### New

- [Registry Access Management]({{< ref "/manuals/Security/Foradmins/HardenedDockerDesktop/RegistryAccessManagement" >}}) is now available for all Docker Business subscriptions. When enabled, your users can access specific registries in Docker Hub.
...
- You can now purchase or upgrade to a Docker Business subscription using a credit card. To learn more, see [Upgrade your subscription]({{< ref "/manuals/Subscription/DockerCore/Upgrade" >}}).
...
For details on how to update your billing information, see [Update billing information]({{< ref "/manuals/Billing" >}}).
...
For more information about this feature and for instructions on how to use it, see [Activity logs]({{< ref "/manuals/Administration/Organizationadministration/Activitylogs" >}}).
...
Docker introduces Hub Vulnerability Scanning which enables you to automatically scan Docker images for vulnerabilities using Snyk. For more information, see [Hub Vulnerability Scanning]({{< ref "/manuals/DockerHub/Staticvulnerabilityscanning" >}}).

## 2020-05-14

### New features

- Docker has announced a new, per-seat pricing model to accelerate developer workflows for cloud-native development. The previous private repository/concurrent autobuild-based plans have been replaced with new **Pro** and **Team** plans that include unlimited private repositories. For more information, see [Docker subscription]({{< ref "/manuals/Subscription" >}}).
- Docker has enabled download rate limits for downloads and pull requests on Docker Hub. This caps the number of objects that users can download within a specified timeframe. For more information, see [Download rate limit]({{< ref "/manuals/DockerHub/Usageandratelimits" >}}).

## 2019-11-04

### Enhancements

- The [repositories page]({{< ref "/manuals/DockerHub/Managerepositories" >}}) and all related settings and tabs have been updated and moved from `cloud.docker.com` to `hub.docker.com`. You can access the page at its new URL: https://hub.docker.com/repositories.
...
- You can now [create personal access tokens]({{< ref "/manuals/Security/Fordevelopers/Accesstokens" >}}) in Docker Hub and use them to authenticate from the Docker CLI. Find them in your account settings, under the new **[Security](https://hub.docker.com/settings/security)** section.
...
- The [billing page]({{< ref "/manuals/Subscription/DockerCore/Upgrade" >}}) for personal accounts has been updated. You can access the page at its new URL: https://hub.docker.com/billing/plan.
