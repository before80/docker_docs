...
> 
>
> Version 4.0.0 and later of `docker/build-push-action` and `docker/bake-action` builds images with [provenance attestations by default](https://docs.docker.com/build/ci/github-actions/attestations/#default-provenance). Docker Build Cloud automatically attempts to load images to the local image store if you don't explicitly push them to a registry.
>
...
{{% tab header="BitBucket Pipelines " %}}
