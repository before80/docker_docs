...
- Docker Desktop no longer installs Notary. You can now use [Docker Content Trust]({{< ref "/manuals/DockerEngine/Security/ContenttrustinDocker" >}}) for image signing.
