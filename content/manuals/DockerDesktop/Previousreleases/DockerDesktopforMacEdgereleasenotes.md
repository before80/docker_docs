...
# Docker Desktop for Mac Edge release notes - Docker Desktop for Mac Edge 版本说明
...
​	有关 Docker Desktop 系统要求，请参阅[安装前须知](https://docs.docker.com/desktop/install/mac-install/#system-requirements)。
...
- Dedicated preference pane for advanced configuration of the docker daemon (edit daemon.json). See [Daemon Advanced (JSON configuration file)](https://docs.docker.com/desktop/settings/#docker-engine).
- Docker Experimental mode can be toggled. See [Daemon Basic (experimental mode and registries)](https://docs.docker.com/desktop/settings/#docker-engine).
