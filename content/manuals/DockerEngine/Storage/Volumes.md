...
Volumes are the preferred mechanism for persisting data generated by and used by Docker containers. While [bind mounts](https://docs.docker.com/engine/storage/bind-mounts/) are dependent on the directory structure and OS of the host machine, volumes are completely managed by Docker. Volumes have several advantages over bind mounts:
...
## [Choose the -v or --mount flag](https://docs.docker.com/engine/storage/volumes/#choose-the--v-or---mount-flag)
...
### [Differences between `-v` and `--mount` behavior](https://docs.docker.com/engine/storage/volumes/#differences-between--v-and---mount-behavior)
...
#### [Syntax differences for services](https://docs.docker.com/engine/storage/volumes/#syntax-differences-for-services)
...
#### [NFSv3](https://docs.docker.com/engine/storage/volumes/#nfsv3)
...
#### [NFSv4](https://docs.docker.com/engine/storage/volumes/#nfsv4)
