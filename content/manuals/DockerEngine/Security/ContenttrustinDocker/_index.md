...
> 
>
> The root key once lost is not recoverable. If you lose any other key, send an email to [Docker Hub Support](https://docs.docker.com/engine/security/trust/). This loss also requires manual intervention from every consumer that used a signed tag from this repository prior to the loss.
...
## [Related information](https://docs.docker.com/engine/security/trust/#related-information)
