...
[Types of plugins](https://docs.docker.com/engine/extend/legacy_plugins/#types-of-plugins)[Installing a plugin](https://docs.docker.com/engine/extend/legacy_plugins/#installing-a-plugin)[Finding a plugin](https://docs.docker.com/engine/extend/legacy_plugins/#finding-a-plugin)[Network plugins](https://docs.docker.com/engine/extend/legacy_plugins/#network-plugins)[Volume plugins](https://docs.docker.com/engine/extend/legacy_plugins/#volume-plugins)[Authorization plugins](https://docs.docker.com/engine/extend/legacy_plugins/#authorization-plugins)[Troubleshooting a plugin](https://docs.docker.com/engine/extend/legacy_plugins/#troubleshooting-a-plugin)[Writing a plugin](https://docs.docker.com/engine/extend/legacy_plugins/#writing-a-plugin)
