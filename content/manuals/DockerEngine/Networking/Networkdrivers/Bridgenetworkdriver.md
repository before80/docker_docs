...
| `com.docker.network.bridge.inhibit_ipv4`                     | `false`                     | Prevent Docker from [assigning an IP address](https://docs.docker.com/engine/network/drivers/bridge/#skip-ip-address-configuration) to the network. |
...
- Option
  ...
  is required, it specifies the network prefix to be used.
