...
![Insights and analytics chart visualization](Insightsandanalytics_img/chart.png)
...
| Data point        | Description                                                  | Date added        |
| ----------------- | ------------------------------------------------------------ | ----------------- |
| Unique IP address | Number of unique IP addresses, see [Privacy](https://docs.docker.com/trusted-content/insights-analytics/#privacy). | January 1, 2022   |
