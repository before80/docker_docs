...
Read our [MUI best practices]({{< ref "/manuals/DockerExtensions/ExtensionsSDK/DesignandUIstyling/MUIbestpractices" >}}) guide to learn future-proof ways to use MUI with Docker Desktop.
...
See our [MUI best practices]({{< ref "/manuals/DockerExtensions/ExtensionsSDK/DesignandUIstyling/MUIbestpractices" >}}) article.
...
- Take a look at our [MUI best practices]({{< ref "/manuals/DockerExtensions/ExtensionsSDK/DesignandUIstyling/MUIbestpractices" >}}).
