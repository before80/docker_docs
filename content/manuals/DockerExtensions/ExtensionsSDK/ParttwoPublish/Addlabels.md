...
| `com.docker.desktop.extension.icon`         | Yes      | The extension icon (format: .svg .png .jpg)                  | https://docs.docker.com/assets/images/engine.svg             |
...
![List preview](Addlabels_img/list-preview.png)
